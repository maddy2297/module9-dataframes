...
newframe <- data.frame("USPersonalExpenditure", stringsAsFactors = FALSE)
...
newframe$category <- row.names(newframe)

# How much money was spent on personal care in 1940?
money1940 <- newframe['1940',]

# How much money was spent on Food and Tobacco in 1960?
money1960 <- newframe['Food and Tobacco', '1960']
